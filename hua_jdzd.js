...
let jd_zdjr_activityId = '0b580315de344700b090b28eff422988'// 活动ID
let jd_zdjr_activityUrl = 'https://lzkjdz-isv.isvjcloud.com/'// 活动地址  lzkjdz-isv
//let jd_zdjr_id = '8927805'  //ID
let jd_zdjr_id = '4819394'
...
function getSimpleActInfoVo() {
    return new Promise(resolve => {
        let options = {
            'url': activityUrl + '/customer/getSimpleActInfoVo',
            'headers': {
            ...
            try {
                if (err) {
                    ...
                    if (resp.status == 200) {
                        ...
                        console.log(activityCookie+'AMD\n')
                    }
                }
            } catch (e) {
                $.logErr(e, resp)
...
function showMsg() {
    return new Promise(resolve => {
        let openAppUrl1 = openAppUrl();
        console.log('运行完毕');
        console.log(openAppUrl1);
        $.msg($.name, '' + $['shopName'], '' + messageTitle + message + ' \n点击弹窗跳转到京东APP活动页面', {
            'open-url': openAppUrl1
        });
        resolve();
    });
}
...
function openAppUrl() {
    let url = activityUrl + '/wxTeam/activity2/' + jd_zdjr_id + '?activityId=' + activityId;
    console.log(url);
    let openApp = url;
...
function getCk() {
    ...
    return new Promise(resolve => {
        let options = {
            'url': activityUrl + '/wxTeam/activity2/'+ jd_zdjr_id +'?activityId=' + activityId,
            'headers': {
                'Cookie': cookie,
                'User-Agent': $.UA
            }
...
function taskPostUrl(url, body) {
    return {
        ...
        'headers': {
            ...
            'Referer': activityUrl + 'wxTeam/activity2/'+ jd_zdjr_id +'?activityId=' + activityId,
